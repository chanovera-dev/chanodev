<?php
/**
 * Template part for displaying the Front Page Call to Action section
 *
 * @package ChanoDev
 */
...
<section class="block home-cta-block blue-background">
    <div class="content">
        <div class="portfolio-cta-box" data-reveal="scale-up">
            ...
            <div class="cta-inner-content" data-reveal="fade-up" style="--delay: 120ms;">
                <?php if ( ! empty( $cta_kicker ) ) : ?>
                    <span class="sub-heading about-kicker"><?php echo esc_html( $cta_kicker ); ?></span>
                <?php endif; ?>
                ...
                <?php if ( ! empty( $cta_btn_txt ) ) : ?>
                    <div class="cta-actions-group">
                        ...
                        <?php if ( ! empty( $cta_reassurance_txt ) ) : ?>
                            <span class="cta-reassurance">
                                ...
                                <?php echo esc_html( $cta_reassurance_txt ); ?>
                            </span>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
